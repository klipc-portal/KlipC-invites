      ...
      <div class="container1">
        ...
        <div class="guest-form">
          ...
          <div class="guest-form-main">
            <div
              class="text2"
            >KlipC 成立于2019年，总部位于美国<span class="color-bc">西雅图</span>，全球超过<span class="color-bc">100,000用户</span>选择，在T4/T5的API跨服务器领域处于<span class="color-bc">行业领先地位</span>。我们即将在各个城市举办线下的技术交流会，向全球市场的<span class="color-bc">明星信号、资管团队、交易红人</span>发出橄榄枝，期待您的积极参与，促进行业发展，为市场带来更多讯息、技术和合作的机会！</div>
          </div>
        </div>
